...
/* Header Guard */
  ...
  ***************************************/  
  ...
  #define COMMS_ERROR_SHIFT_READ_CMD          (4) /**< Shift of a null readCmd function */
  ...
  #define COMMS_ERROR_READ_CMD                (1u << COMMS_ERROR_SHIFT_READ_CMD)        /**< Flag of a null read command function */
  ...
  ***************************************/ 
  ...
  typedef struct {
    ...
    uint32_t (*readCmd)(uint8_t deviceAdr, uint8_t *result, uint16_t len);                      /**< Reads data without a register/command value*/
